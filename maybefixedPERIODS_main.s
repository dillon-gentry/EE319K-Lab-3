...
loop  
		...
		LDR R1,= 0x1E8480			;Delay function (150ms)
d30IH	SUBS R1, #1
		BNE d30IH
		...
		LDR R1,= 0x47352B			;Delay function (350ms)
d30IL	SUBS R1, #1
		BNE d30IL
		BEQ loop
...
dt10	AND R2,R2,#0
		...
		LDR R1,= 0xA2C2A			;Delay function (50 ms)
d10H	SUBS R1, #1
		BNE d10H
		...
		LDR R1,= 0x5B8D80			;Delay function (450ms)
d10L	SUBS R1, #1
		BNE d10L
		BEQ check
		;////////////////////////////////////////////////////////
...
dt50	AND R2,R2,#0
		...
		LDR R1,= 0x32DCD5			;Delay function (250ms)
d50H	SUBS R1, #1
		BNE d50H
...
d90H	SUBS R1, #1
		...
		LDR R1,= 0xA2C2A			;Delay function (50ms)
d90L	SUBS R1, #1
		BNE d90L
		BEQ check
		;///////////////////////////////////////////////////////
